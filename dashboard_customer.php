...
$displayName = $_SESSION['user_name'] ?? $_SESSION['name'] ?? $_SESSION['username'] ?? $_SESSION['customer_name'] ?? null;
...
<body>
    <div class="container">
        ...
        <div class="welcome-message">
            <p>
                Welcome<?php if (!empty($displayName)): ?>
            ...
            <div class="search-grid">
                ...
                <div>
                    ...
                    <select id="serviceCategory" name="service" class="select-field">
                        ...
                        <option value="Painter" <?= ($last_search['service'] === 'Painter') ? 'selected' : ''; ?>>Painter</option>
                    </select>
                </div>
            </div>
        ...
        <div id="search" class="results-grid">
            <?php if ($search_performed): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <p class="hint" style="text-align:center;font-size:1.1rem; margin-top:40px;">Enter a location and service to find providers nearby.</p>
            <?php endif; ?>
        </div>
